...
matlab -nodisplay -nosplash -batch "try; addpath(getenv('USER_SPM_DIR')); run('/mnt/iusers01/nm01/j90161ms/~longitudinal_vbm/normalise.m'); catch ME; disp(getReport(ME)); exit(1); end; exit(0);"
