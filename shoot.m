...
rc1_files = sort(fullfile({dir(fullfile(base_dir, 'rc1avg_*.nii')).folder}, {dir(fullfile(base_dir, 'rc1avg_*.nii')).name}));
rc2_files = sort(fullfile({dir(fullfile(base_dir, 'rc2avg_*.nii')).folder}, {dir(fullfile(base_dir, 'rc2avg_*.nii')).name}));
